...
public class Surface extends RefCnt {
   ...
   //("_ -> new")
    public static Surface makeRasterDirect( Pixmap pixmap) {
   ...
   //("_, _, _ -> new")
    public static Surface makeRasterDirect( ImageInfo imageInfo,
                                           long pixelsPtr,
                                           long rowBytes) {
   ...
   //("_, _, _ -> new")
    public static Surface makeRaster( ImageInfo imageInfo) {
   ...
   //("_, _, _ -> new")
    ...
    public static Surface makeFromMTKView( DirectContext context,
                                          long mtkViewPtr,
                                           SurfaceOrigin origin,
                                          int sampleCount,
                                           SurfaceColorFormat colorFormat,
   ...
   //("_, _, _ -> new")
    public static Surface makeRenderTarget( DirectContext context,
                                           boolean budgeted,
                                            ImageInfo imageInfo) {
