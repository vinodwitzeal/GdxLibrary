...
public class ImageInfo {
    ...
    public ImageInfo(ColorInfo _colorInfo, int _width, int _height) {
        this._colorInfo = _colorInfo;
        this._width = _width;
   ...
   //("_, _ -> new")
    ...
    public ImageInfo withColorType( ColorType colorType) {
    ...
    public ImageInfo withColorAlphaType( ColorAlphaType alphaType) {
    ...
    public ImageInfo withColorSpace( ColorSpace colorSpace) {
        return withColorInfo(_colorInfo.withColorSpace(colorSpace));
    }


    public ImageInfo withColorInfo(ColorInfo colorInfo){
        if (colorInfo==_colorInfo)return this;
        return new ImageInfo(colorInfo,_width,_height);
    }
