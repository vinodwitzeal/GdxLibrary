...
public class PathSegment {
    ...
    public PathSegment(PathVerb _verb, Point _p0, Point _p1, Point _p2, Point _p3, float _conicWeight, boolean _closeLine, boolean _closedContour) {
        this._verb = _verb;
        this._p0 = _p0;
        this._p1 = _p1;
        this._p2 = _p2;
        this._p3 = _p3;
        this._conicWeight = _conicWeight;
        this._closeLine = _closeLine;
        this._closedContour = _closedContour;
    }
