...
public class TextBlobBuilder extends Managed {
     ...
     * @return this
     */
    public TextBlobBuilder appendRun(Font font, String text, float x, float y,  Rect bounds) {
     ...
     * @return this
     */
    public TextBlobBuilder appendRun(Font font, short[] glyphs, float x, float y,  Rect bounds) {
        try {
            Stats.onNativeCall();
     ...
     * @return this
     */
    public TextBlobBuilder appendRunPosH(Font font, short[] glyphs, float[] xs, float y,  Rect bounds) {
        try {
     ...
     * @return this
     */
    public TextBlobBuilder appendRunPos(Font font, short[] glyphs, Point[] pos,  Rect bounds) {
        try {
