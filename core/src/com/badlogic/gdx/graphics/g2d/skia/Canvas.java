...
public class Canvas extends Managed {
   ...
   //("_, _, _, _, _, _, _, _ -> this")
    public Canvas drawArc(float left, float top, float right, float bottom, float startAngle, float sweepAngle, boolean includeCenter,  Paint paint) {
   ...
   //("_, _, _ -> this")
    ...
    public Canvas drawRectShadow( Rect r, float dx, float dy, float blur, int color) {
        return drawRectShadow(r, dx, dy, blur, 0f, color);
    }

    
    
    public Canvas drawRectShadow( Rect r, float dx, float dy, float blur, float spread, int color) {
    ...
    public Canvas drawRectShadowNoclip( Rect r, float dx, float dy, float blur, float spread, int color) {
        assert r != null : "Can’t drawRectShadow with r == null";
   ...
   //("_, _, _, _ -> this")
    public Canvas drawImageRect( Image image,  Rect src,  Rect dst) {
   ...
   //("_, _, _, _, _ -> this")
    public Canvas drawImageRect( Image image,  Rect src,  Rect dst,  SamplingMode samplingMode,  Paint paint, boolean strict) {
   ...
   //("_, _, _, _, _ -> this")
    public Canvas drawImageNine( Image image,  IRect center,  Rect dst,  FilterMode filterMode,  Paint paint) {
   ...
   //("_, _, _, _ -> this")
    public Canvas drawTextBlob( TextBlob blob, float x, float y,  Paint paint) {
   ...
   //("_, _, _, _ -> this")
    public Canvas drawTextLine( TextLine line, float x, float y,  Paint paint) {
   ...
   //("_, _, _ -> this")
    public Canvas drawTriangles( Point[] positions,  int[] colors,  Paint paint) {
   ...
   //("_, _, _, _, _ -> this")
    public Canvas drawTriangles( Point[] positions,  int[] colors,  Point[] texCoords,  short[] indices,  Paint paint) {
   ...
   //("_, _, _, _, _, _ -> this")
    public Canvas drawTriangles( Point[] positions,  int[] colors,  Point[] texCoords,  short[] indices,  BlendMode mode,  Paint paint) {
   ...
   //("_, _, _ -> this")
    public Canvas drawTriangleStrip( Point[] positions,  int[] colors,  Paint paint) {
   ...
   //("_, _, _, _, _ -> this")
    public Canvas drawTriangleStrip( Point[] positions,  int[] colors,  Point[] texCoords,  short[] indices,  Paint paint) {
   ...
   //("_, _, _, _, _, _ -> this")
    public Canvas drawTriangleStrip( Point[] positions,  int[] colors,  Point[] texCoords,  short[] indices,  BlendMode mode,  Paint paint) {
   ...
   //("_, _, _ -> this")
    public Canvas drawTriangleFan( Point[] positions,  int[] colors,  Paint paint) {
   ...
   //("_, _, _, _, _ -> this")
    public Canvas drawTriangleFan( Point[] positions,  int[] colors,  Point[] texCoords,  short[] indices,  Paint paint) {
   ...
   //("_, _, _, _, _, _ -> this")
    public Canvas drawTriangleFan( Point[] positions,  int[] colors,  Point[] texCoords,  short[] indices,  BlendMode mode,  Paint paint) {
   ...
   //("_, _, _ -> this")
    public Canvas drawPatch( Point[] cubics,  int[] colors,  Paint paint) {
   ...
   //("_, _, _, _ -> this")
    public Canvas drawPatch( Point[] cubics,  int[] colors,  Point[] texCoords,  Paint paint) {
   ...
   //("_, _, _, _, _ -> this")
    public Canvas drawPatch( Point[] cubics,  int[] colors,  Point[] texCoords,  BlendMode mode,  Paint paint) {
    ...
    public Canvas drawDrawable( Drawable drawable) {
   ...
   //("_, _, _ -> this")
    public Canvas drawDrawable( Drawable drawable, float x, float y) {
    ...
    public Canvas drawDrawable( Drawable drawable,  Matrix33 matrix) {
    ...
    public Canvas setMatrix( Matrix33 matrix) {
   ...
   //("_, _, _ -> this")
     ...
     */
    public int saveLayer( Rect bounds,  Paint paint) {
        try {
            Stats.onNativeCall();
            if (bounds == null)
