...
public class Bitmap extends Managed implements IHasImageInfo {
   ...
   //("-> new")
    public static Bitmap makeFromImage( Image image) {
     ...
     */
    public boolean allocPixelsFlags( ImageInfo imageInfo, boolean zeroPixels) {
        try {
            _imageInfo = null;
            Stats.onNativeCall();
     ...
     */
    public boolean allocPixels( ImageInfo info, long rowBytes) {
        try {
            _imageInfo = null;
            Stats.onNativeCall();
     ...
     */
    public boolean installPixels( ImageInfo info,
                                  byte[] pixels,
                                 long rowBytes) {
        try {
            _imageInfo = null;
   ...
   //("_, _, _ -> this")
    public Bitmap setPixelRef( PixelRef pixelRef, int dx, int dy) {
        try {
            _imageInfo = null;
            Stats.onNativeCall();
     ...
     */
    public boolean extractSubset( Bitmap dst,  IRect subset) {
        try {
            Stats.onNativeCall();
    ...
    public byte[] readPixels( ImageInfo dstInfo, long dstRowBytes, int srcX, int srcY) {
        try {
            Stats.onNativeCall();
     ...
     */
    public boolean extractAlpha( Bitmap dst) {
    ...
    public IPoint extractAlpha( Bitmap dst,  Paint paint) {
        try {
            Stats.onNativeCall();
    ...
    public Shader makeShader( FilterTileMode tmx,
                              FilterTileMode tmy,
    ...
    public static native boolean _nSetImageInfo(long ptr, int width, int height, int colorType, int alphaType, long colorSpacePtr, long rowBytes);

    public static native boolean _nAllocPixelsFlags(long ptr, int width, int height, int colorType, int alphaType, long colorSpacePtr, int flags);

    public static native boolean _nAllocPixelsRowBytes(long ptr, int width, int height, int colorType, int alphaType, long colorSpacePtr, long rowBytes);

    public static native boolean _nInstallPixels(long ptr, int width, int height, int colorType, int alphaType, long colorSpacePtr, byte[] pixels, long rowBytes);
    ...
    public static native void _nEraseColor(long ptr, int color);

    public static native void _nErase(long ptr, int color, int left, int top, int right, int bottom);
    ...
    public static native byte[] _nReadPixels(long ptr, int width, int height, int colorType, int alphaType, long colorSpacePtr, long dstRowBytes, int srcX, int srcY);
