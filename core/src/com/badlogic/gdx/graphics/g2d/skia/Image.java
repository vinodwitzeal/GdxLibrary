...
public class Image extends RefCnt implements IHasImageInfo {
   ...
   //("_ -> new")
    public static Image makeFromBitmap( Bitmap bitmap) {
        try {
   ...
   //("_ -> new")
    public static Image makeFromPixmap( Pixmap pixmap) {
        try {
   ...
   //("_ -> new")
    ...
    public boolean readPixels( Bitmap dst) {
        return readPixels(null, dst, 0, 0, false);
    }

    public boolean readPixels( Bitmap dst, int srcX, int srcY) {
     ...
     */
    public boolean readPixels( DirectContext context,  Bitmap dst, int srcX, int srcY, boolean cache) {
        try {
    ...
    public boolean readPixels( Pixmap dst, int srcX, int srcY, boolean cache) {
        try {
            assert dst != null : "Can’t readPixels with dst == null";
    ...
    public boolean scalePixels( Pixmap dst, SamplingMode samplingMode, boolean cache) {
        try {
    ...
    public static native long _nMakeRaster(int width, int height, int colorType, int alphaType, long colorSpacePtr, byte[] pixels, long rowBytes);

    public static native long _nMakeRasterData(int width, int height, int colorType, int alphaType, long colorSpacePtr, long dataPtr, long rowBytes);

    public static native long _nMakeFromBitmap(long bitmapPtr);

    public static native long _nMakeFromPixmap(long pixmapPtr);
    ...
    public static native boolean _nReadPixelsBitmap(long ptr, long contextPtr, long bitmapPtr, int srcX, int srcY, boolean cache);
