...
public class Picture extends RefCnt {
     ...
     * @see <a href="https://fiddle.skia.org/c/@Picture_playback">https://fiddle.skia.org/c/@Picture_playback</a>
     */
    public Picture playback(Canvas canvas,  BooleanSupplier abort) {
        try {
            Stats.onNativeCall();
     ...
     */
    public static Picture makePlaceholder( Rect cull) {
        Stats.onNativeCall();
    ...
    public static native void _nPlayback(long ptr, long canvasPtr,  BooleanSupplier abort);
    ...
    public static native long _nMakeShader(long ptr, int tmx, int tmy, int filterMode, float[] localMatrix, Rect tileRect);
}