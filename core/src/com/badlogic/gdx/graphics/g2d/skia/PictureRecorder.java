...
public class PictureRecorder extends Managed {
     ...
     */
    public Picture finishRecordingAsPicture( Rect cull) {
        try {
            Stats.onNativeCall();
     ...
     */
    // public Drawable finishRecordingAsPicture( Rect cull) {
    //     Stats.onNativeCall();
    ...
    public static native long _nGetRecordingCanvas(long ptr);

    public static native long _nFinishRecordingAsPicture(long ptr);

    public static native long _nFinishRecordingAsPictureWithCull(long ptr, float left, float top, float right, float bottom);
