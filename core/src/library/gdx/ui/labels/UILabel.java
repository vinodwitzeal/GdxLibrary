...
public class UILabel extends Widget {
    ...
    public UILabel (@Null CharSequence text, UILabelStyle style) {
    ...
    /** Returns the label's style. Modifying the returned style may not have an effect until {@link #setStyle(UILabelStyle)} is
     * called. */
    ...
    private void scaleAndComputePrefSize () {
        ...
        computePrefSize(UILabel.prefSizeLayout);
    ...
    /** The style for a label, see {@link UILabel}.
     * @author Nathan Sweet */
    static public class UILabelStyle {
        public Font font;
        ...
        public UILabelStyle (Font font, @Null Color fontColor) {
            this.font = font;
            this.fontColor = fontColor;
        }

        public UILabelStyle(FontType fontType,float size,@Null Color fontColor){
            this(FontUtils.scaledFont(fontType,size),fontColor);
        }

        public UILabelStyle (UILabelStyle style) {
            font = style.font;
