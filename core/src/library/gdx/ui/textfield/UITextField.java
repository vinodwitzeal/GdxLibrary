 ...
 * <p>
 * The preferred height of a text field is the height of the {@link UITextFieldStyle#font} and {@link UITextFieldStyle#background}.
 ...
 * @author mzechner
 * @author Nathan Sweet */
public class UITextField extends Widget implements Disableable {
    ...
    @Null UITextFieldListener listener;
    ...
    public UITextField (@Null String text, UITextFieldStyle style) {
        setStyle(style);
    ...
    public void setStyle (UITextFieldStyle style) {
    ...
    /** Returns the text field's style. Modifying the returned style may not have an effect until {@link #setStyle(UITextFieldStyle)}
     * is called. */
    public UITextFieldStyle getStyle () {
        return style;
    }
    ...
    /** Copies the contents of this UITextField to the {@link Clipboard} implementation set on this UITextField. */
    public void copy () {
    ...
    /** Copies the selected contents of this UITextField to the {@link Clipboard} implementation set on this UITextField, then removes
     * it. */
    public void cut () {
    ...
    /** Sets the {@link Stage#setKeyboardFocus(Actor) keyboard focus} to the next UITextField. If no next text field is found, the
    ...
    public void next (boolean up) {
        ...
        while (true) {
            UITextField textField = current.findNextTextField(stage.getActors(), null, bestCoords, currentCoords, up);
    ...
    /** @return May be null. */
    private @Null UITextField findNextTextField (Array<Actor> actors, @Null UITextField best, Vector2 bestCoords,
                                               Vector2 currentCoords, boolean up) {
        for (int i = 0, n = actors.size; i < n; i++) {
            Actor actor = actors.get(i);
            if (actor instanceof UITextField) {
                if (actor == this) continue;
                UITextField textField = (UITextField)actor;
    ...
    public void setTextFieldListener (@Null UITextFieldListener listener) {
     ...
     * @author mzechner */
    static public interface UITextFieldListener {
        public void keyTyped (UITextField textField, char c);
    }

    /** Interface for filtering characters entered into the text field.
     * @author mzechner */
    static public interface TextFieldFilter {
        public boolean acceptChar (UITextField textField, char c);
    ...
    /** The default {@link OnscreenKeyboard} used by all {@link UITextField} instances. Just uses
    ...
    public class TextFieldClickListener extends ClickListener {
        ...
        public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
            ...
            Stage stage = getStage();
            if (stage != null) stage.setKeyboardFocus(UITextField.this);
            keyboard.show(true);
            hasSelection = true;
            return true;
        }
        ...
        /** Checks if focus traversal should be triggered. The default implementation uses {@link UITextField#focusTraversal} and the
         * typed character, depending on the OS.
         * @param character The character that triggered a possible focus traversal.
         * @return true if the focus should change to the {@link UITextField#next(boolean) next} input field. */
        ...
        public boolean keyTyped (InputEvent event, char character) {
            ...
            if (checkFocusTraversal(character))
                ...
                if (add || remove) {
                    ...
                    if (add && !remove) {
                        ...
                        if (!enter && filter != null && !filter.acceptChar(UITextField.this, character)) return true;
            ...
            if (listener != null) listener.keyTyped(UITextField.this, character);
            return true;
        }
    }

    /** The style for a text field, see {@link UITextField}.
     * @author mzechner
     * @author Nathan Sweet */
    static public class UITextFieldStyle {
        public Font font;
        ...
        public UITextFieldStyle () {
        }

        public UITextFieldStyle (Font font, Color fontColor, @Null Drawable cursor, @Null Drawable selection,
        ...
        public UITextFieldStyle (UITextFieldStyle style) {
            font = style.font;
