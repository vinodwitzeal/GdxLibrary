    ...
    namespace svg {
        namespace SVGLength {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/svg/SVGLength");
        ...
        namespace SVGPreserveAspectRatio {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/svg/SVGPreserveAspectRatio");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
