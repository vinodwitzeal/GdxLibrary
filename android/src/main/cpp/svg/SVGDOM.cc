...
extern "C" JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_svg_SVGDOMKt_SVGDOM_1nMakeFromData
...
extern "C" JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_svg_SVGDOMKt_SVGDOM_1nGetRoot
...
extern "C" JNIEXPORT void JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_svg_SVGDOMKt_SVGDOM_1nGetContainerSize
...
extern "C" JNIEXPORT void JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_svg_SVGDOMKt_SVGDOM_1nSetContainerSize
  (JNIEnv* env, jclass jclass, jlong ptr, jfloat width, jfloat height) {
    SkSVGDOM* instance = reinterpret_cast<SkSVGDOM*>(static_cast<uintptr_t>(ptr));
    instance->setContainerSize(SkSize{width, height});
}

extern "C" JNIEXPORT void JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_svg_SVGDOMKt_SVGDOM_1nRender
