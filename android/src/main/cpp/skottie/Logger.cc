...
extern "C" JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_skottie_LoggerKt__1nMake
  (JNIEnv* env, jclass jclass) {
    SkikoLogger* instance = new SkikoLogger();
    return reinterpret_cast<jlong>(instance);
}

extern "C" JNIEXPORT void JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_skottie_Logger_1jvmKt__1nInit
