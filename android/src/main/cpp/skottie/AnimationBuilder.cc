...
extern "C" JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_skottie_AnimationBuilderKt_AnimationBuilder_1nGetFinalizer
  (JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteAnimationBuilder));
}

extern "C" JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_skottie_AnimationBuilderKt_AnimationBuilder_1nMake
  (JNIEnv* env, jclass jclass, jint flags) {
    return reinterpret_cast<jlong>(new Animation::Builder(flags));
}

extern "C" JNIEXPORT void JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_skottie_AnimationBuilderKt__1nSetFontManager
...
extern "C" JNIEXPORT void JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_skottie_AnimationBuilderKt__1nSetLogger
...
extern "C" JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_skottie_AnimationBuilderKt__1nBuildFromString
...
extern "C" JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_skottie_AnimationBuilderKt__1nBuildFromFile
...
extern "C" JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_graphics_g2d_skia_skottie_AnimationBuilderKt__1nBuildFromData
