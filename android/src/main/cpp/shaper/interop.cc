    ...
    namespace shaper {
        namespace BidiRun {
            ...
            void onLoad(JNIEnv* env) {
                jclass cls = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/BidiRun");
        ...
        namespace FontMgrRunIterator {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/FontMgrRunIterator");
        ...
        namespace FontRun {
            ...
            void onLoad(JNIEnv* env) {
                jclass cls = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/FontRun");
                _end = env->GetFieldID(cls, "end", "I");
        ...
        namespace HbIcuScriptRunIterator {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/HbIcuScriptRunIterator");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
            }
        ...
        namespace IcuBidiRunIterator {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/IcuBidiRunIterator");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
            }
        ...
        namespace LanguageRun {
            ...
            void onLoad(JNIEnv* env) {
                jclass cls = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/LanguageRun");
                _end = env->GetFieldID(cls, "end", "I");
        ...
        namespace RunHandler {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/RunHandler");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
        ...
        namespace RunInfo {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/RunInfo");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
        ...
        namespace ScriptRun {
            ...
            void onLoad(JNIEnv* env) {
                jclass cls = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/ScriptRun");
                _end = env->GetFieldID(cls, "end", "I");
        ...
        namespace ShapingOptions {
            ...
            void onLoad(JNIEnv* env) {
                jclass cls = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/ShapingOptions");
        ...
        namespace TextBlobBuilderRunHandler {
            ...
            void onLoad(JNIEnv* env) {
                jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/shaper/TextBlobBuilderRunHandler");
                cls  = static_cast<jclass>(env->NewGlobalRef(local));
            }
