...
Java_com_badlogic_gdx_graphics_g2d_skia_RuntimeEffectKt__1nMakeShader(JNIEnv* env,
                                                     jclass jclass,
                                                     jlong ptr,
                                                     jlong uniformPtr,
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_badlogic_gdx_graphics_g2d_skia_RuntimeEffectKt__1nMakeForShader(JNIEnv* env, jclass jclass, jstring sksl) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_badlogic_gdx_graphics_g2d_skia_RuntimeEffectKt__1nMakeForColorFilter(JNIEnv* env,
                                                             jclass jclass,
                                                             jstring sksl) {
    SkString skslProper = skString(env, sksl);
