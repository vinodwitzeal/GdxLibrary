...
namespace skija {
    namespace AnimationFrameInfo {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/AnimationFrameInfo");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace Color4f {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/Color4f");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace Drawable {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/Drawable");
            cls = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontFamilyName {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/FontFamilyName");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontFeature {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/FontFeature");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontMetrics {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/FontMetrics");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontMgr {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/FontMgr");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
        }
    ...
    namespace FontVariation {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/FontVariation");
            cls   = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace FontVariationAxis {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/FontVariationAxis");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace ImageInfo {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/ImageInfo");
            cls   = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace IPoint {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/IPoint");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace IRect {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/IRect");
            cls      = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace Path {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/Path");
            cls          = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace PathSegment {
        ...
        void onLoad(JNIEnv* env) {
            jclass local  = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/PathSegment");
            cls           = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace Point {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/Point");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace PaintFilterCanvas {
        ...
        void onLoad(JNIEnv* env) {
            env->GetJavaVM(&_vm);
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/PaintFilterCanvas");
    ...
    namespace Rect {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/Rect");
            cls      = static_cast<jclass>(env->NewGlobalRef(local));
    ...
    namespace RRect {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/RRect");
            cls      = static_cast<jclass>(env->NewGlobalRef(local));
   ...
   namespace RSXform {
        ...
        void onLoad(JNIEnv* env) {
            jclass local = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/RSXform");
            cls  = static_cast<jclass>(env->NewGlobalRef(local));
            ctor = env->GetMethodID(cls, "<init>", "(FFFF)V");
        }
    ...
    namespace impl {
        namespace Native {
            ...
            void onLoad(JNIEnv* env) {
                jclass cls = env->FindClass("com/badlogic/gdx/graphics/g2d/skia/impl/Native");
