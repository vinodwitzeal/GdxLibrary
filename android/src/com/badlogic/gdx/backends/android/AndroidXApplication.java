 ...
 * 
 * @author mzechner */
public class AndroidXApplication extends ComponentActivity implements AndroidApplicationBase {
	...
	private MultiplePermissionResultListener multiplePermissionResultListener;
	...
	private void init (ApplicationListener listener, AndroidApplicationConfiguration config, boolean isForView) {
		...
		singlePermissionLauncher=registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
			@Override
			public void onActivityResult(Boolean result) {
				if (permissionResultListener!=null){
					permissionResultListener.onResult(result);
				}
			}
		});

		multiplePermissionLauncher =registerForActivityResult(new ActivityResultContracts.RequestMultiplePermissions(), o -> {
			if (multiplePermissionResultListener !=null) {
				multiplePermissionResultListener.onResult(o);
			}
		});
	}

	public void requestPermission(String[] permission, MultiplePermissionResultListener permissionResultListener){
		this.multiplePermissionResultListener =permissionResultListener;
		multiplePermissionLauncher.launch(permission);
	}

	public void requestPermission(String permission,PermissionResultListener permissionResultListener){
	...
	public void exit () {
		handler.post(new Runnable() {
			@Override
			public void run () {
				AndroidXApplication.this.finish();
			}
		});
	}
